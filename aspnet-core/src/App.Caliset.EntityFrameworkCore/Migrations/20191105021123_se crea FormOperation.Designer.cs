...
namespace App.Caliset.Migrations
{
    ...
    [Migration("20191105021123_se crea FormOperation")]
    partial class secreaFormOperation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Caliset.Models.HoursRecords.HourRecord", b =>
                {
                    ...
                    b.ToTable("HoursRecord");
                });

            modelBuilder.Entity("App.Caliset.Models.LocationRecord.LocationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("App.Caliset.Models.OperationStates.OperationState", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationTime = new DateTime(2019, 11, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            Name = "Futura"
                        },
                        new
            ...
            modelBuilder.Entity("App.Caliset.Models.UserDeviceTokens.UserDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("App.Caliset.Models.UserFile.UserFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("App.Caliset.Models.UserDeviceTokens.UserDeviceToken", b =>
                {
                    b.HasOne("App.Caliset.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
