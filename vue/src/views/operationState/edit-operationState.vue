<template>
    <div>
        <Modal :title="L('EditOperationState')"
               :value="value"
               @on-ok="save"
...
<script lang="ts">
    ...
    @Component
    export default class EditOperationState extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.operationState = Util.extend(true, {}, this.$store.state.operationState.editOperationState);
            }
        }
